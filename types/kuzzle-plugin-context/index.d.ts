...
export interface KuzzlePluginLogs {
    silly(msg: string|any): Promise<void>
    verbose(msg: string|any): Promise<void>
    info(msg: string|any): Promise<void>
    debug(msg: string|any): Promise<void>
    warn(msg: string|any): Promise<void>
    error(msg: string|any): Promise<void>
}
...
export interface KuzzlePluginContext {
    accessors: {
        ...
        execute(request: KuzzleRequest): Promise<any>
        execute(request: KuzzleRequest, callback: (err: Error, request: KuzzleRequest) => any): void
    }
